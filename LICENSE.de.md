...
1. **Was diese Lizenz abdeckt und was nicht.** Sie deckt den Code in diesem Repository ab, also die Seite, den Bluetooth-Kern, die Node-Abfrage und die Dokumentation. Sie deckt die Firmware des Roller-Herstellers **nicht** ab. Diese Firmware ist urheberrechtlich geschütztes Werk des Herstellers. Sie wird hier nicht verbreitet und diese Lizenz gibt dir keinerlei Recht daran.

2. **Keine Gewähr für das, was du damit schreibst.** Die Geräte-Identität eines Rollers zu ändern (die FIN, also den ausgestrahlten BLE-Namen) kann ein Fahrzeug in einen Zustand bringen, den seine Betriebserlaubnis nicht abdeckte. Wer eine solche Identität schreibt, trägt dafür die Verantwortung, nicht der Autor dieses Werkzeugs.
